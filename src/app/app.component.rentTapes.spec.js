...
describe('RentTapes', function () {
    ...
    beforeEach(testing_1.async(function () {
        testing_1.TestBed.configureTestingModule({
            declarations: [app_component_rentTapes_1.RentTapes, app_borrow_component_1.BorrowComponent, app_filter_pipe_1.MovieFilterPipe, app_rented_pipe_1.RentedPipe, app_free_pipe_1.FreePipe, app_sort_pipe_1.SortPipe],
            imports: [testing_2.RouterTestingModule, forms_1.FormsModule, http_1.HttpModule],
            providers: [app_movie_service_1.MovieService]
        })
            .overrideComponent(app_component_rentTapes_1.RentTapes, {
            set: {
    ...
    beforeEach(function () {
        fixture = testing_1.TestBed.createComponent(app_component_rentTapes_1.RentTapes);
        comp = fixture.componentInstance;
        de = fixture.debugElement.query(platform_browser_1.By.css('about'));
...
//# sourceMappingURL=app.component.rentTapes.spec.js.map